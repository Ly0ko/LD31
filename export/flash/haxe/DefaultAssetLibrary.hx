...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/mapTiles.png", __ASSET__assets_images_maptiles_png);
		type.set ("assets/images/mapTiles.png", AssetType.IMAGE);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_maptiles_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
//@:file("assets/data/map.csv") class __ASSET__assets_data_map_csv extends lime.utils.ByteArray {}
//@:file("assets/images/images-go-here.txt") class __ASSET__assets_images_images_go_here_txt extends lime.utils.ByteArray {}
//@:bitmap("assets/images/mapTiles.png") class __ASSET__assets_images_maptiles_png extends openfl.display.BitmapData {}
